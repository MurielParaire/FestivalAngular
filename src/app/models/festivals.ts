...
export class Festival {
   ...
   public constructor(
      name: string,
      @Optional() id?: string,
      @Optional() entranceLoc: number = 0,  // première partie de salle
      @Optional() mainRoomLoc: number = 0,   // deuxième partie de salle
      @Optional() cafetLoc: number = 0, // étage de la buvette
